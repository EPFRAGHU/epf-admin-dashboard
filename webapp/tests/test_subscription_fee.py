...
def test_subscription_fee_rate_hierarchy(superadmin_session, consultant_a):
    ...
    res = consultant_a.post("/api/establishments", json={"coverage_date": "01-04-2015", "code": "ALPHA001", "name": "Alpha Corp"})
    assert res.status_code == 200
    ...
    res = consultant_a.put("/api/establishment", json={"coverage_date": "01-04-2015", "code": "ALPHA001", "name": "Alpha Corp", "custom_rate_per_employee": 15.0})
    assert res.status_code == 200
