      ...
      <div class="card-head" style="margin-bottom:12px">
        <div>
          ...
          <div class="card-subtitle" style="margin-top: 6px; font-size: 11px; color: var(--text3);">
            ...
            ${emp.eps_member === false ? '<span class="badge high" style="margin-left:6px; font-size:10px;">Not EPS Member</span>' : ''}
          </div>
...
function addEmployeeToBulkWageTable(emp) {
  ...
  if (!window.bulkTableVisibleIds.includes(emp.member_id)) {
    ...
    if (!bulkTableState[emp.member_id]) {
      bulkTableState[emp.member_id] = { g: 0, w: 0, n: 0, higher_ee: false, higher_er: false, pohw: false, pohw116: false, isCopied: false };
    }
...
window.initBulkTableState = () => {
  ...
  allEmps.forEach(master => {
    ...
    let g = 0, w = 0, n = 0, higher_ee = false, higher_er = false, pohw = false, pohw116 = false, isCopied = false;
    ...
    if (shouldShow) {
      ...
      bulkTableState[master.member_id] = { g, w, n, higher_ee, higher_er, pohw, pohw116, isCopied };
    }
  });
...
window.renderMonthlyTable = () => {
  ...
  sliced.forEach((master, idx) => {
    ...
    const { g, w, n, higher_ee, higher_er, pohw, pohw116, isCopied } = state;
            ...
            <tr class="bulk-row-info" data-id="${App.esc(master.member_id)}" style="${rowBg}">
              <td colspan="13" style="padding:10px 14px 8px 14px;">
                <div style="display:flex; align-items:center; gap:8px; flex-wrap:wrap; margin-bottom:8px;">
                  ...
                  ${master.eps_member === false ? '<span class="badge high" style="font-size:11px; font-weight:700; padding:3px 8px;">Not EPS Member</span>' : ''}
